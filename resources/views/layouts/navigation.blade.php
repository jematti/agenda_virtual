<nav x-data="{ open: false }" class="bg-gradient-to-r from-cyan-500 to-blue-500 border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-base font-bold text-white ">
